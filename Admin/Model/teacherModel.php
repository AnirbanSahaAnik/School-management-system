...
function updateMyInfo($id, $userinfo){
    $conn = getConnection();
    $sql = "update teacher set id='{$userinfo['id']}', name='{$userinfo['name']}' , email='{$userinfo['email']}', mobile='{$userinfo['mobile']}', gender='{$userinfo['gender']}', dob='{$userinfo['dob']}',  where id='{$id}'";
